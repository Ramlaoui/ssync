<script lang="ts">
  ...
  import ModernEventsView from '../components/ModernEventsView.svelte';
  import AttachWatchersDialog from '../components/AttachWatchersDialogEnhanced.svelte';
  import StreamlinedWatcherCreator from '../components/StreamlinedWatcherCreator.svelte';
