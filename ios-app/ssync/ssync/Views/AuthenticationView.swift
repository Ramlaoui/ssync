...
struct AuthenticationView: View {
    ...
    private func authenticate() {
        ...
        // Update auth manager
        authManager.serverURL = normalizedServerURL
        authManager.apiKey = normalizedAPIKey

        // Ensure testConnection uses the latest server URL
        UserDefaults.standard.set(normalizedServerURL, forKey: "api_base_url")
