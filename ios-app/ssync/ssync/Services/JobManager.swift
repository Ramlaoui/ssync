    ...
    private func updateJobState(jobId: String, state: JobState) {
        if let index = jobs.firstIndex(where: { $0.id == jobId }) {
            ...
            let newJob = Job(
                ...
                stdoutFile: updatedJob.stdoutFile,
                stderrFile: updatedJob.stderrFile,
                submitLine: updatedJob.submitLine,
...
extension Notification.Name {
    ...
    static let jobNotificationOpenJob = Notification.Name("jobNotificationOpenJob")
}
