...
class AppState: ObservableObject {
    ...
    private func handleJobUpdate(_ job: Job) {
        ...
        if job.state.isCompleted && JobPreferencesManager.shared.notificationsEnabled(for: job) {
...
// Manual conformance due to associated values.
extension AppState.ConnectionStatus: Equatable {
    static func == (lhs: AppState.ConnectionStatus, rhs: AppState.ConnectionStatus) -> Bool {
        switch (lhs, rhs) {
